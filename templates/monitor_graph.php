...
<div class="card mb-3">
	...
	<div class="card-body">
		<button class="btn btn-light dropdown-toggle ml-1 mb-3" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo esc_html( ucfirst( $label ) ); ?></button>
